"""
Helena - Task 3.1.1 Improved: Drug Recommendation 
Model: RETAIN (Attention-based EHR modeling)
...
if __name__ == "__main__":
    ...
    ####################################
    # 0. SET SEED (Required for reproducibility - Section 3.1)
    ####################################
    set_seed(42)
    ...
    ####################################
    # STEP 3: define RETAIN model
    ####################################
    print(">> Step 3: Define RETAIN model")
    # RETAIN uses embedding_dim to derive its internal attention layers
    model = RETAIN(
    ...
    ####################################
    # STEP 5: Final Evaluation & Manual Metrics
    ####################################
